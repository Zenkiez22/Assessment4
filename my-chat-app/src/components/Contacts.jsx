    ...
    <>
      {currentUserImage && (
        <div className='grid grid-flow-row overflow-hidden w-1/4 bg-gray-900 rounded-lg'>
          <div>
            <h3 className='text-center p-1 text-black-400 bg-indigo-600'>Chat with friends</h3>
          </div>
          <div className="flex flex-col items-center overflow-auto space-x-3">
            {contacts.map((contact, index) => {
              return (
                <div
                  key={contact._id}
                  className={`h-20 cursor-pointer bg-cyan-500 rounded-lg mb-2 w-11/12 p-1 flex gap-3 items-center transition delay-75 ease-in-out ${
          ...
          <div className="bg-indigo-800 flex justify-center items-center gap-2 rounded-md p-1">
            <div>
              <img
